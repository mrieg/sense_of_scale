...
module FalseColorLegendApp = 
    ...
    let initial =
        {
            useFalseColors = true
            lowerBound     = Numeric.init
            upperBound     = Numeric.init
            interval       = Numeric.init
            invertMapping  = false
            lowerColor     = ColorPicker.init
            upperColor     = ColorPicker.init
        }
    ...
    let app : App<FalseColorsModel,MFalseColorsModel,Action> =
        {
            ...
            initial = initial //InitValues.falseColors
            update = update
            view = view
        }
