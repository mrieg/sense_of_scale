...
module Mutable =
    ...
    module Urdar =
        ...
        module Lens =
            let urdar =
                { new Lens<Demo.TestApp.Urdar, System.Int32>() with
    ...
    module Model =
        ...
        module Lens =
            let boxHovered =
                { new Lens<Demo.TestApp.Model, System.Boolean>() with
            ...
            let lastName =
                { new Lens<Demo.TestApp.Model, Microsoft.FSharp.Core.Option<System.String>>() with
                    override x.Get(r) = r.lastName
                    override x.Set(r,v) = { r with lastName = v }
                    override x.Update(r,f) = { r with lastName = f r.lastName }
                }
            let elements =
                { new Lens<Demo.TestApp.Model, Aardvark.Base.plist<System.String>>() with
            ...
            let boxScale =
                { new Lens<Demo.TestApp.Model, System.Double>() with
                    override x.Get(r) = r.boxScale
                    override x.Set(r,v) = { r with boxScale = v }
                    override x.Update(r,f) = { r with boxScale = f r.boxScale }
                }
            let objects =
                { new Lens<Demo.TestApp.Model, Aardvark.Base.hmap<System.String,Demo.TestApp.Urdar>>() with
            ...
            let tree =
                { new Lens<Demo.TestApp.Model, Demo.TestApp.Tree<System.Int32>>() with
